...
function showAntibody(PDB_ID, epitopeResID, receptorResID, chain1_ID, chain2_ID, chain1_type, chain2_type, antigenChain) {
	...
	var chain = [[chain1_ID, chain1_type, "#800000"],[chain2_ID, chain2_type, "#00CED1"],[antigenChain,"Epitope Chain","#B0C4DE"]];
...
function showTCR(PDB_ID, epitopeMHCResID, epitopeTCRResID, mhcEpitopeResID, tcrEpitopeResID, chain1_ID, chain2_ID, mhc_chain1_ID, mhc_chain2_ID, chain1_type, chain2_type, mhc_chain1_type, mhc_chain2_type, epitopeChain) {
	
	var PDBurl = getPDBurl(PDB_ID);
	
	var interactiveResID = [[epitopeMHCResID,"MHC-epitope Residues","#0000FF"],[epitopeTCRResID,"TCR-epitope Residues","#0000FF"],[mhcEpitopeResID,"epitope-MHC Residues","#FFD700"],[tcrEpitopeResID,"epitope-TCR Residues","#FFD700"]];
	
	var chain = [[mhc_chain1_ID, mhc_chain1_type, "#FF00FF"],[mhc_chain2_ID, mhc_chain2_type, "#006400"],[chain1_ID, chain1_type, "#800000"],[chain2_ID, chain2_type, "#00CED1"],[epitopeChain,"Epitope Chain","#B0C4DE"]];
	
	showComplex(PDBurl, interactiveResID, chain);
	
};

function showMHC(PDB_ID, epitopeResID, mhcResID,mhc_chain1_ID, mhc_chain2_ID, mhc_chain1_type, mhc_chain2_type, epitopeChain) {
	
	var PDBurl = getPDBurl(PDB_ID);
	
	var interactiveResID = [[epitopeResID,"Epitope Residues","#0000FF"],[mhcResID,"epitope-MHC Residue","#FFD700"]];
	
	var chain = [[mhc_chain1_ID, mhc_chain1_type, "#FF00FF"],[mhc_chain2_ID, mhc_chain2_type, "#006400"],[epitopeChain,"Epitope Chain","#B0C4DE"]];
...
function showComplex(url, interactiveResID, chain) {
	...
	+ ';'
	//turn everything off
	+ 'select all; cartoon off; wireframe off; spacefill off;'
